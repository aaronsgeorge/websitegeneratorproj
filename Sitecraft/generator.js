    ...
    <img src="${homePhotoUrl}" alt="Home Photo">
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                <img src="testimonial1.jpg" alt="" class="testimonial_img">

                                <div>
                                    <h3 class="testimonial_name">Rolston Fernandes</h3>
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                ...
                                <div>
                                    <h3 class="testimonial_name">Colin D'Souza</h3>
                                    <span class="testimonial_client">Client</span>
                                </div>
                            </div>
                    ...
                    <div class="testimonial_content swiper-slide">
                        <div class="testimonial_data">
                            <div class="testimonial_header">
                                ...
                                <div>
                                    <h3 class="testimonial_name">Jiol Simon</h3>
                                    <span class="testimonial_client">Client</span>
                                </div>
                            </div>
                ...
                <div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">+91 987654321</span>
                        </div>
                    </div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">user@gmail.com</span>
                        </div>
                    </div>
                    <div class="contact_information">
                        ...
                        <div>
                            ...
                            <span class="contact_subtitle">User</span>
                        </div>
                    </div>
                </div>
        ...
        <footer class="footer">
          <div class="footer_bg">
            ...
            <p class="footer_copy">&#169; SiteCraft All right reserved</p>
          </div>
        </footer>
